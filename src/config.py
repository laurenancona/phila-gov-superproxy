...
__author__ = 'ancona.lauren@gmail.com (Lauren Ancona)'

# OAuth 2.0 Client Settings
AUTH_CONFIG = {
    'OAUTH_CLIENT_ID': '627951649996-020987bmacp2s4ve8dgujpe6sq634ult.apps.googleusercontent.com',
    'OAUTH_CLIENT_SECRET': 'FQh-3oYKDTAPuFLtfBwuyQ0N',

    # E.g. Local Dev Env on port 8080: http://localhost:8080
    # E.g. Hosted on App Engine: https://your-application-id.appspot.com
    'OAUTH_REDIRECT_URI': '%s%s' % (
        'https://phila-gov-superproxy.appspot.com',
        '/admin/auth')
}
